// Package analyzer provides an interface for modules that can be used with the grompt command-line tool.
// It also exposes prompt engineering capabilities for use as a library.
package analyzer

import (
	"github.com/kubex-ecosystem/gemx/analyzer/factory/providers"
	"github.com/kubex-ecosystem/gemx/analyzer/internal/engine"
	m "github.com/kubex-ecosystem/gemx/analyzer/internal/module"
	st "github.com/kubex-ecosystem/gemx/analyzer/internal/module/control"
...
// It defines the GemxAnalyzer interface which can be implemented by any module
// that wants to be part of the grompt ecosystem.

// GemxAnalyzer represents the main CLI interface
type GemxAnalyzer interface {
...
// NewGrompt creates a new GemxAnalyzer CLI instance
func NewGrompt() GemxAnalyzer {
	return m.RegX()
}
