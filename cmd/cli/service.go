...
import (
	...
	"github.com/kubex-ecosystem/gemx/analyzer/utils"
	"gopkg.in/yaml.v3"

	s "github.com/kubex-ecosystem/gemx/analyzer/internal/services/server"
	t "github.com/kubex-ecosystem/gemx/analyzer/internal/types"
...
func startServer() *cobra.Command {
	...
	var startCmd = &cobra.Command{
		...
		Annotations: GetDescriptions([]string{
			"This command starts the GemxAnalyzer server.",
			"This command initializes the GemxAnalyzer server and starts waiting for help to build prompts.",
		}, false),
		Run: func(cmd *cobra.Command, args []string) {
			...
			gl.Log("success", "GemxAnalyzer server started successfully")
		},
	}
